...
public class SetDemo {
    ...
    public void printFilteredSignupList() {
        ...
        Set<String> filterStringList = new HashSet<>();
        for (List<String> strings : unfilteredSignupList) {
            filterStringList.addAll(strings);
        }
        filterStringList.forEach(System.out::println);
